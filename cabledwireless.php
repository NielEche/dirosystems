                            ...
                            <div class="blog-standard">
                                <div class="single-blog-standard mt-30">
                                    <div class="blog-standard-thumb">
                                        <img src="assets/images/it4.jpg" alt="blog">
                                    </div>
                                    <div class="blog-standard-content">
                                        <span>Information Technology, Services</span>  
                                        <h2 class="title">Network Infrastructure (Cabled/Wireless)</h2>
                                    </div> 
                                </div> 
                                            ...
                                            <div class="shop-product-area ml-30">
                                                <div class="shop-active">
                                                    <div class="shop-product-item">
                                                        <img src="assets/images/indexx.jpg" alt="">
                                                    </div>                      
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-8">
                                            <div class="shop-details-content ml-30">
                                                ...
                                                <div class="list d-flex">
                                                    <p>We provide physical layer network design using a combination of new and innovative technologies that include Category 6 Ethernet cabling, fibre optics as well as PowerLine (Power to Ethernet) networking which eliminates some physical cabling requirements.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
