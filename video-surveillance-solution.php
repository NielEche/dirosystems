                            ...
                            <div class="blog-standard">
                                <div class="single-blog-standard mt-30">
                                    <div class="blog-standard-thumb">
                                        <img src="assets/images/it2.jpg" alt="blog">
                                    </div>
                                    <div class="blog-standard-content">
                                        <span>Information Technology, Services</span>  
                                        <h2 class="title">Video Surveillance Solution</h2>
                                    </div> 
                                </div> 
                                  ...
                                  <div class="row">
                                        ...
                                        <div class="col-lg-8">
                                            <div class="shop-details-content ml-30">
                                                <div class="review ">
                                                    <h5 style="font-size: 22px !important;" class="title">Video Surveillance </h5>
                                                </div>
                                                <div class="list d-flex">
                                                    <p>Several times we have seen the footage of CCTV cameras on TV especially related to any showroom or banks. The hidden functionally of CCTV camera is very useful where you want to check any ones attitude or behavior and especially when he or she does not know about it. Through this security system you can put an eye on whatevet that is happening in your organisation. It happens that at the time of any miss happening we are not able to catch the victim but afterwards at least we can catch victim with the help of CCTV. CCTV camera security systems are not for secure your home only rather you can use this in your Office era or your organisation. Diro systems has partened with Huawei to provide you with the best and qualite CCTV Surveillance cameres.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
