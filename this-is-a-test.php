                            ...
                            <div class="blog-standard">
                                <div class="single-blog-standard mt-30">
                                    <div class="blog-standard-thumb">
                                        <img src="assets/images/is1.png" alt="blog">
                                    </div>
                                    <div class="blog-standard-content">
                                        <span>Information Systems</span>
                                        <h2 class="title">Other Services We Provide</h2>
                                        <p>Procurement of (HP, Cisco, Dell, Huawei, NetApp etc) Systems<br>
                                            • We have an excellent procurement process that delivers consistently on time and at a competitive pricing level.<br>
                                         IT Security and Backup/Disaster Recovery Systems<br>
                                            • We can help with your Security, Backup and Disaster Recovery challenges <br>
                                        Virtualisation (VMware, Hyper-V, Citrix)<br>
                                            • We have experience of deploying virtualised network infrastructure Managed Services for IT Infrastructure<br>
                                            • We can take the strain o you and look after your infrastructure completely and enable you to get on with your business.<br>
                                        Asset verification and analysis<br>
                                            • We can help you verify and tag your assets to protect your investment<br>
                                        Logistics Routines: Periodic backup, Media (tape, disc) changes, CCTV and Power
                                        integrity checks<br>
                                            • We can handle your routine logistics around backed up data and integrity checks<br>
                                        Training and Consultancy Services<br>
                                            • We can organise and deliver your critical IT trainings.</p>
