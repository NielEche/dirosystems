                            ...
                            <div class="blog-standard">
                                <div class="single-blog-standard mt-30">
                                    <div class="blog-standard-thumb">
                                        <img src="assets/images/it3.png" alt="blog">
                                    </div>
                                  ...
                                  <div class="row">
                                            ...
                                            <div class="shop-product-area ml-30">
                                                <div class="shop-active">
                                                    <div class="shop-product-item">
                                                        <img src="assets/images/Capture4.png" alt="">
                                                    </div>                      
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-8">
                                            <div class="shop-details-content ml-30">
                                                <div class="review ">
                                                    <h5 style="font-size: 22px !important;" class="title">Access Control and Visitor Management System </h5>
                                                </div>
                                                <div class="list d-flex">
                                                    <p>Our solution is a comprehensive and flexible access control solution designed to meet the access control needs of any organization irrespective of its size, locations, layouts, and timings.
                                                    It allows control of access on all three simultaneous dimensions – user, zone and time by answering the three fundamental questions about who, where and when. In addition, value-added features such as anti-pass back, 2-person rule, first-in user, blocked users, door auto relock, guard tour, man-trap and smart card identification ensure fool proof security of physical assets and safety of manpower.</p>
                                                </div>
                                            </div>
                                            <div class="shop-details-area pt-50 pb-50 gray-bg">
                                                <div class="container-fluid">
                                                  <div class="row">
                                                        <div class="col-lg-12">
                                                            <div class="shop-product-area ml-30">
                                                                <div class="shop-active">
                                                                    <div class="shop-product-item">
                                                                        <img src="assets/images/Capture3.png" alt="">
                                                                    </div>                      
                                                                </div>
                                                            </div>
                                                        </div>
