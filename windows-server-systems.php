                            ...
                            <div class="blog-standard">
                                <div class="single-blog-standard mt-30">
                                    <div class="blog-standard-thumb">
                                        <img src="assets/images/is4.png" alt="blog">
                                    </div>
                                    <div class="blog-standard-content">
                                        <span>Information Systems, Services</span>
                                        <h2 class="title">Microsoft Windows Server & Desktop systems</h2>
                                        <p>Any large, medium or small scale businesses can benefit from the advantages of a server-based network. Putting a fast and well-equipped server to work increases your productivity, enables smart backup and archiving, and vastly improves the security of your data.<br>
                                        <img class="size-medium wp-image-487 aligncenter" src="assets/images/win.jpg" alt="" srcset="assets/images/win.jpg 300w, assets/images/win.jpg 150w, assets/images/win.jpg 350w" sizes="(max-width: 300px) 100vw, 300px" width="300" height="300"></p>
                                         <p>Outlined here are some of the benefits your organisation and your work-force can benefit from our Windows Server Deployment:</p>
                                    </div>
                                </div>  
                            </div>
                            
                            <div class="shop-details-area pt-50 pb-50 gray-bg">
                                                ...
                                                <div class="accordion" id="accordionExample">
                                                    <div class="card wow fadeInLeft" data-wow-duration=".1.2s" data-wow-delay=".2s">
                                                        <div class="card-header" id="headingOne">
                                                            <a class="" href="" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                                                <i class="fal fa-magic"></i>File Management
                                                            </a>
                                                        </div>

                                                        <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordionExample">
                                                            <div class="card-body">
                                                                <p>How much time do you spend trying to track down documents that move around the office from employee to employee without anyone keeping track? A more efficient idea: storing your vital data in a central shared space where all workers can access it whenever the need comes up.</p>
                                                            </div>
                                                        </div>
                                                    </div> <!-- card -->
                                                    <div class="card wow fadeInLeft" data-wow-duration=".1.2s" data-wow-delay=".3s">
                                                        ...
                                                        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionExample">
                                                            <div class="card-body">
                                                                <p>As handheld smart phones and Wi-Fi-connected notebooks have become ubiquitous, your office is now accessible 24/7. That means your smart phone not just your notebook can become a true extension of your office. Windows Servers deliver secure access to business contacts, calendars, e-mail, files, and other important desktop resources from any Internet-connected computer. You’re always connected.</p>
                                                            </div>
                                                        </div>
                                                    </div> <!-- card -->
                                                    <div class="card wow fadeInLeft" data-wow-duration=".1.2s" data-wow-delay=".4s">
                                                        <div class="card-header" id="headingThree">
                                                            <a class="collapsed" href="" data-toggle="collapse" data-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                                                                <i class="fal fa-magic"></i>Security
                                                            </a>
                                                        </div>
                                                        <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordionExample">
                                                            <div class="card-body">
                                                                <p>The network administrator of a server-based network can control access to critical and private files on a person-by-person basis, and with the inclusion of a firewall, the entire organization can be guarded from intrusions and attacks. The end result: a more buttoned-up organization where security concerns needn’t preoccupy you constantly. Windows Servers give you control over your systems with daily and weekly reports alerting you on the health and security of your technology.</p>
                                                            </div>
                                                        </div>
                                                    </div> <!-- card -->
                                                        ...
                                                        <div class="card-header" id="headingFour">
                                                            <a class="collapsed" href="" data-toggle="collapse" data-target="#collapseFour" aria-expanded="false" aria-controls="collapseFour">
                                                                <i class="fal fa-magic"></i>Collaboration
                                                            </a>
                                                        </div>
                                                        <div id="collapseFour" class="collapse" aria-labelledby="headingFour" data-parent="#accordionExample">
                                                            <div class="card-body">
                                                                <p>In a server-based network, workgroups can work together in virtual spaces, sharing schedules, files, and whatever else they need to get the job done. You can also grant access to outside clients and customers to make those communications more efficient and make your business appear bigger than it actually is.</p>
                                                            </div>
                                                        </div>
                                                    </div> <!-- card -->
